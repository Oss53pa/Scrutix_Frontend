  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-16 py-12">
        ...
        {config.socialLinks && (
          <div className="flex items-center gap-4 mb-12">
            {config.socialLinks.linkedin && config.socialLinks.linkedin.startsWith('https://') && (
              <a
            ...
            {config.socialLinks.twitter && config.socialLinks.twitter.startsWith('https://') && (
              <a
            ...
            {config.socialLinks.facebook && config.socialLinks.facebook.startsWith('https://') && (
              <a
      ...
      <div className="flex-shrink-0 px-16 py-8 border-t border-current/20">
        ...
        {/* Generated by AtlasBanx */}
        <p className="text-xs opacity-40 text-center mt-4">
          Rapport généré par <span className="font-display text-base">AtlasBanx</span> - Solution d'audit bancaire
        </p>
