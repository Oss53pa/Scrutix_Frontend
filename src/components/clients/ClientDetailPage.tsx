      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <div className={`px-2 py-0.5 rounded-full text-xs font-medium ${analytics.riskColor === 'red' ? 'bg-red-100 text-red-700' : analytics.riskColor === 'yellow' ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700'}`}>
