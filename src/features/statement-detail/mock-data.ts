...
export const MOCK_ANOMALIES: Anomaly[] = [
  ...
  // -----------------------------------------------------------------
  {
    ...
    conventionEvidence: {
      tierAppliedLabel: 'Entreprise / Personne morale',
      tierAppliedKey: 'tenueCompte.entreprise',
      conventionAmount: 60000,
      actualAmount: 87600,
      excessAmount: 27600,
      conventionDocId: 'doc-tarifs-nsia-2026',
      note: 'Plafond mensuel conventionnel : 60 000 FCFA pour entreprise PM. Facturation effective : 87 600 FCFA. Écart de 27 600 FCFA à régulariser au titre de l\'article 7.3.',
    },
    qualifiedBy: { userId: USERS.kadi.userId, userHandle: USERS.kadi.handle, at: daysAgo(1) },
  ...
  // -----------------------------------------------------------------
  {
    ...
    conventionEvidence: {
      tierAppliedLabel: 'Entreprise / Personne morale',
      tierAppliedKey: 'credits.tauxAgiosT1',
      conventionAmount: 14250,
      actualAmount: 18700,
      excessAmount: 4450,
      note: 'Méthode des nombres SYSCOHADA. Taux conventionnel : 12,50 %. Taux appliqué : 16,35 %. Écart annualisé : 3,85 points.',
    },
  ...
  // -----------------------------------------------------------------
  {
    ...
    conventionEvidence: {
      tierAppliedLabel: 'Entreprise / Personne morale',
      tierAppliedKey: 'ebanking.smsAlerteAbonnement',
      conventionAmount: 1000,
      actualAmount: 2000,
      excessAmount: 1000,
      note: 'L\'abonnement SMS est conventionnellement prélevé 1× / mois. Détecté 2× le 28/04/2026.',
    },
